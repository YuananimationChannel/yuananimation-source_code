...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		add(gfDance);
		add(logoBl);
		//FlxTween.tween(logoBl,{y: logoBl + 60}, 1, {ease: FlxEase.expoInOut, startDelay: 0.5 + (0.2 * i)});
	...
	function skipIntro():Void
	{
		if (!skippedIntro)
		{
			...
			FlxTween.tween(logoBl, {x: -100, y: -100}, {ease: FlxEase.expoInOut, startDelay: 0.2});
			FlxTween.tween(gfDance, {y: 50}, {ease: FlxEase.expoInOut, startDelay: 0.8});
			remove(credGroup);
			skippedIntro = true;
		}
	}
